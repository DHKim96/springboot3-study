...
class TokenProviderTest {
    ...
    void getAuthentication() {
        ...
        //then
        String test = ((UserDetails)authentication.getPrincipal()).getUsername();
        // authentication.getPrincipal() 은 반환 타입이 Object 이기 때문에 실제로 담겨있는 객체에 따라 캐스팅을 해줘야 함
        assertThat(test).isEqualTo(userEmail);
    }
